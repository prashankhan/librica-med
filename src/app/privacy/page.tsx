    ...
    <PageContainer className={SECTION_PAD_Y}>
      <div className={PAGE_READING_MAX_CLASS}>
        <header className="mb-8">
          <h1 className={PAGE_H1_CLASS}>Privacy policy</h1>
        ...
        <div className={`space-y-8 ${PAGE_LEAD_CLASS}`}>
          <section>
            <h2 className={PAGE_SECTION_TITLE_CLASS}>Who we are</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className={PAGE_SECTION_TITLE_CLASS}>Information we collect</h2>
          ...
          <section>
            <h2 className={PAGE_SECTION_TITLE_CLASS}>How we use information</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className={PAGE_SECTION_TITLE_CLASS}>Sharing</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className={PAGE_SECTION_TITLE_CLASS}>Security</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className={PAGE_SECTION_TITLE_CLASS}>Your choices</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className={PAGE_SECTION_TITLE_CLASS}>Updates</h2>
            <p className="mt-3">
