/**
 * Public site configuration — safe to import in client components.
 */
export const SITE_NAME = "Librica Med";
export const SITE_URL = "https://libricamed.lk";
export const SITE_DESCRIPTION =
  "Sri Lanka’s first registered online medical book shop. Professional medical books with islandwide delivery and WhatsApp-assisted ordering.";

export const WHATSAPP_E164 = "94716200863";
